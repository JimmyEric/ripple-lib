...
let HEX_ZERO = UInt160.HEX_ZERO = '0000000000000000000000000000000000000000';
let HEX_ONE = UInt160.HEX_ONE = '0000000000000000000000000000000000000001';
...
UInt160.prototype.to_json = function(opts_) {
  let opts = opts_ || {};

  if (!this.is_valid()) {
    // XXX
    // Other UInts return null...
    return NaN;
  }
